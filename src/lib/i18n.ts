...
const resources = {
  en: {
    translation: {
      ...
      importProjectsDescription: 'Import multiple projects from a ZIP file exported from Shakespeare. You can choose which projects to import and handle conflicts with existing projects.',
      importMultipleProjects: 'Import Multiple Projects',
      foundProjects: 'Found {{count}} project | Found {{count}} projects',
      selectAll: 'Select All',
      deselectAll: 'Deselect All',
      conflict: 'Conflict',
      willOverwriteExisting: 'Will overwrite existing project',
      analyzingZipFile: 'Analyzing ZIP file...',
      discoveringProjects: 'Discovering projects and checking for conflicts...',
      importingProjects: 'Importing {{count}} project | Importing {{count}} projects',
      extractingFiles: 'Extracting files and setting up projects...',
      projectsImportedSuccessfully: 'Projects imported successfully!',
      overwriteExistingProjects: 'Overwrite Existing Projects',
      selectedProjectsExist: 'You have selected {{count}} project that already exists: | You have selected {{count}} projects that already exist:',
      overwriteWillDelete: 'Delete all existing files in these projects',
      overwriteWillReplace: 'Replace them with files from the ZIP archive',
      overwriteWillPreserveGit: 'Preserve Git history if it exists',
      overwriteWillKeepAI: 'Keep AI chat history and session data',
      yesOverwriteProjects: 'Yes, Overwrite Projects',
      importAndOverwrite: 'Import & Overwrite ({{count}})',
      projectsImported: '{{count}} Project Imported Successfully | {{count}} Projects Imported Successfully',
      someProjectsFailed: '{{count}} project failed to import | {{count}} projects failed to import',
      allProjectsReadyToUse: 'All projects have been imported and are ready to use.',
      importFailed: 'Import Failed',
      failedToImportProjects: 'Failed to import projects',
  ...
  pt: {
    translation: {
      ...
      importProjectsDescription: 'Importe múltiplos projetos de um arquivo ZIP exportado do Shakespeare. Você pode escolher quais projetos importar e lidar com conflitos com projetos existentes.',
      importMultipleProjects: 'Importar Múltiplos Projetos',
      foundProjects: '{{count}} projeto encontrado | {{count}} projetos encontrados',
      selectAll: 'Selecionar Todos',
      deselectAll: 'Desmarcar Todos',
      conflict: 'Conflito',
      willOverwriteExisting: 'Substituirá projeto existente',
      analyzingZipFile: 'Analisando arquivo ZIP...',
      discoveringProjects: 'Descobrindo projetos e verificando conflitos...',
      importingProjects: 'Importando {{count}} projeto | Importando {{count}} projetos',
      extractingFiles: 'Extraindo arquivos e configurando projetos...',
      projectsImportedSuccessfully: 'Projetos importados com sucesso!',
      overwriteExistingProjects: 'Substituir Projetos Existentes',
      selectedProjectsExist: 'Você selecionou {{count}} projeto que já existe: | Você selecionou {{count}} projetos que já existem:',
      overwriteWillDelete: 'Excluir todos os arquivos existentes nestes projetos',
      overwriteWillReplace: 'Substituí-los por arquivos do arquivo ZIP',
      overwriteWillPreserveGit: 'Preservar histórico Git se existir',
      overwriteWillKeepAI: 'Manter histórico de chat IA e dados de sessão',
      yesOverwriteProjects: 'Sim, Substituir Projetos',
      importAndOverwrite: 'Importar e Substituir ({{count}})',
      projectsImported: '{{count}} Projeto Importado com Sucesso | {{count}} Projetos Importados com Sucesso',
      someProjectsFailed: '{{count}} projeto falhou ao importar | {{count}} projetos falharam ao importar',
      allProjectsReadyToUse: 'Todos os projetos foram importados e estão prontos para uso.',
      importFailed: 'Importação Falhou',
      failedToImportProjects: 'Falha ao importar projetos',
      bulkImportFailed: 'Importação em lote falhou',
  ...
  zh: {
    translation: {
      ...
      // Project Import
      importProjects: '导入项目',
      importProjectsDescription: '从Shakespeare导出的ZIP文件导入多个项目。您可以选择要导入的项目并处理与现有项目的冲突。',
      importMultipleProjects: '导入多个项目',
      foundProjects: '找到{{count}}个项目',
      selectAll: '全选',
      deselectAll: '取消全选',
      conflict: '冲突',
      willOverwriteExisting: '将覆盖现有项目',
      analyzingZipFile: '正在分析ZIP文件...',
      discoveringProjects: '正在发现项目并检查冲突...',
      importingProjects: '正在导入{{count}}个项目',
      extractingFiles: '正在提取文件并设置项目...',
      projectsImportedSuccessfully: '项目导入成功！',
      overwriteExistingProjects: '覆盖现有项目',
      selectedProjectsExist: '您已选择{{count}}个已存在的项目：',
      overwriteWillDelete: '删除这些项目中的所有现有文件',
      overwriteWillReplace: '用ZIP存档中的文件替换它们',
      overwriteWillPreserveGit: '如果存在，保留Git历史',
      overwriteWillKeepAI: '保留AI聊天历史和会话数据',
      yesOverwriteProjects: '是的，覆盖项目',
      importAndOverwrite: '导入并覆盖（{{count}}）',
      projectsImported: '{{count}}个项目导入成功',
      someProjectsFailed: '{{count}}个项目导入失败',
      allProjectsReadyToUse: '所有项目已导入并准备使用。',
      importFailed: '导入失败',
      failedToImportProjects: '导入项目失败',
  ...
  ha: {
    translation: {
      ...
      // Project Import
      importProjects: 'Shigo da Ayyuka',
      importProjectsDescription: 'Shigo da ayyuka da yawa daga fayil ɗin ZIP da aka fitar daga Shakespeare. Kuna iya zaɓar waɗanne ayyukan da za ku shigo da su da kuma magance rikice-rikice da ayyukan da ke akwai.',
      importMultipleProjects: 'Shigo da Ayyuka da Yawa',
      foundProjects: 'An samo aikin {{count}} | An samo ayyuka {{count}}',
      selectAll: 'Zaɓa Duk',
      deselectAll: 'Cire Zaɓin Duk',
      conflict: 'Rikici',
      willOverwriteExisting: 'Zai sake rubuta aikin da ke akwai',
      analyzingZipFile: 'Ana nazarin fayil ɗin ZIP...',
      discoveringProjects: 'Ana gano ayyuka da bincika rikice-rikice...',
      importingProjects: 'Ana shigo da aikin {{count}} | Ana shigo da ayyuka {{count}}',
      extractingFiles: 'Ana cire fayiloli da saita ayyuka...',
      projectsImportedSuccessfully: 'An shigo da ayyuka cikin nasara!',
      overwriteExistingProjects: 'Sake Rubuta Ayyukan da ke Akwai',
      selectedProjectsExist: 'Kun zaɓi aikin {{count}} wanda ya riga ya kasance: | Kun zaɓi ayyuka {{count}} waɗanda suka riga sun kasance:',
      overwriteWillDelete: 'Share duk fayilolin da ke akwai a cikin waɗannan ayyuka',
      overwriteWillReplace: 'Maye gurbinsu da fayiloli daga ZIP archive',
      overwriteWillPreserveGit: 'Kiyaye tarihin Git idan ya kasance',
      overwriteWillKeepAI: 'Ajiye tarihin hira na AI da bayanan zama',
      yesOverwriteProjects: 'Eh, Sake Rubuta Ayyuka',
      importAndOverwrite: 'Shigo da kuma Sake Rubuta ({{count}})',
      projectsImported: 'An Shigo da Aikin {{count}} cikin Nasara | An Shigo da Ayyuka {{count}} cikin Nasara',
      someProjectsFailed: 'Aikin {{count}} ya gaza shigowa | Ayyuka {{count}} sun gaza shigowa',
      allProjectsReadyToUse: 'An shigo da duk ayyuka kuma suna shirye don amfani.',
      importFailed: 'Shigowa Ya Gaza',
      failedToImportProjects: 'Ya gaza shigo da ayyuka',
      bulkImportFailed: 'Shigowa da yawa ya gaza',
  ...
  yo: {
    translation: {
      ...
      // Project Import
      importProjects: 'Gbe Awọn Iṣẹ Akanṣe Wọle',
      importProjectsDescription: 'Gbe awọn iṣẹ akanṣe pupọ wọle lati faili ZIP ti a ṣe export lati Shakespeare. O le yan awọn iṣẹ akanṣe wo ni lati gbe wọle ati koju awọn ija pẹlu awọn iṣẹ akanṣe ti o wa tẹlẹ.',
      importMultipleProjects: 'Gbe Awọn Iṣẹ Akanṣe Pupọ Wọle',
      foundProjects: 'Ri iṣẹ akanṣe {{count}} | Ri awọn iṣẹ akanṣe {{count}}',
      selectAll: 'Yan Gbogbo',
      deselectAll: 'Yọ Gbogbo Yiyan',
      conflict: 'Ija',
      willOverwriteExisting: 'Yoo tun kọ iṣẹ akanṣe ti o wa tẹlẹ',
      analyzingZipFile: 'N ṣe itupalẹ faili ZIP...',
      discoveringProjects: 'N ṣe awari awọn iṣẹ akanṣe ati ṣayẹwo awọn ija...',
      importingProjects: 'N gbe iṣẹ akanṣe {{count}} wọle | N gbe awọn iṣẹ akanṣe {{count}} wọle',
      extractingFiles: 'N yọ awọn faili ati ṣeto awọn iṣẹ akanṣe...',
      projectsImportedSuccessfully: 'A ti gbe awọn iṣẹ akanṣe wọle ni aṣeyọri!',
      overwriteExistingProjects: 'Tun Kọ Awọn Iṣẹ Akanṣe Ti O Wa Tẹlẹ',
      selectedProjectsExist: 'O ti yan iṣẹ akanṣe {{count}} ti o wa tẹlẹ: | O ti yan awọn iṣẹ akanṣe {{count}} ti o wa tẹlẹ:',
      overwriteWillDelete: 'Pa gbogbo awọn faili ti o wa tẹlẹ ninu awọn iṣẹ akanṣe wọnyi',
      overwriteWillReplace: 'Rọpọ wọn pẹlu awọn faili lati ZIP archive',
      overwriteWillPreserveGit: 'Tọju itan Git ti o ba wa',
      overwriteWillKeepAI: 'Tọju itan ibaraẹnisọrọ AI ati data igba',
      yesOverwriteProjects: 'Bẹẹni, Tun Kọ Awọn Iṣẹ Akanṣe',
      importAndOverwrite: 'Gbe Wọle ati Tun Kọ ({{count}})',
      projectsImported: 'A Ti Gbe Iṣẹ Akanṣe {{count}} Wọle Ni Aṣeyọri | A Ti Gbe Awọn Iṣẹ Akanṣe {{count}} Wọle Ni Aṣeyọri',
      someProjectsFailed: 'Iṣẹ akanṣe {{count}} kuna lati gbe wọle | Awọn iṣẹ akanṣe {{count}} kuna lati gbe wọle',
      allProjectsReadyToUse: 'A ti gbe gbogbo awọn iṣẹ akanṣe wọle ati pe wọn ti ṣetan fun lilo.',
      importFailed: 'Gbigbe Wọle Kuna',
      failedToImportProjects: 'O kuna lati gbe awọn iṣẹ akanṣe wọle',
      bulkImportFailed: 'Gbigbe wọle pupọ kuna',
  ...
  ig: {
    translation: {
      ...
      // Project Import
      importProjects: 'Bubata Ọrụ',
      importProjectsDescription: 'Bubata ọtụtụ ọrụ site na faịlụ ZIP e wepụtara na Shakespeare. Ị nwere ike ịhọrọ ọrụ ndị ị ga-ebubata ma dozie esemokwu na ọrụ ndị dị adị.',
      importMultipleProjects: 'Bubata Ọtụtụ Ọrụ',
      foundProjects: 'Achọtara ọrụ {{count}} | Achọtara ọrụ {{count}}',
      selectAll: 'Họrọ Niile',
      deselectAll: 'Wepụ Nhọrọ Niile',
      conflict: 'Esemokwu',
      willOverwriteExisting: 'Ga-edegharị ọrụ dị adị',
      analyzingZipFile: 'Na-enyocha faịlụ ZIP...',
      discoveringProjects: 'Na-achọpụta ọrụ ma na-enyocha esemokwu...',
      importingProjects: 'Na-ebubata ọrụ {{count}} | Na-ebubata ọrụ {{count}}',
      extractingFiles: 'Na-ewepụta faịlụ ma na-ahazi ọrụ...',
      projectsImportedSuccessfully: 'E bubatara ọrụ nke ọma!',
      overwriteExistingProjects: 'Degharịa Ọrụ Ndị Dị Adị',
      selectedProjectsExist: 'Ị ahọrọla ọrụ {{count}} nke dị adị: | Ị ahọrọla ọrụ {{count}} ndị dị adị:',
      overwriteWillDelete: 'Hichapụ faịlụ niile dị adị na ọrụ ndị a',
      overwriteWillReplace: 'Dochie ha na faịlụ sitere na ZIP archive',
      overwriteWillPreserveGit: 'Chekwaa akụkọ Git ma ọ bụrụ na ọ dị',
      overwriteWillKeepAI: 'Chekwaa akụkọ mkparịta ụka AI na data oge',
      yesOverwriteProjects: 'Ee, Degharịa Ọrụ',
      importAndOverwrite: 'Bubata ma Degharịa ({{count}})',
      projectsImported: 'E Bubatara Ọrụ {{count}} Nke Ọma | E Bubatara Ọrụ {{count}} Nke Ọma',
      someProjectsFailed: 'Ọrụ {{count}} dara ịbubata | Ọrụ {{count}} dara ịbubata',
      allProjectsReadyToUse: 'E bubatala ọrụ niile ma ha dị njikere maka iji.',
      importFailed: 'Mbubata Dara',
      failedToImportProjects: 'O dara ịbubata ọrụ',
      bulkImportFailed: 'Mbubata ọtụtụ dara',
