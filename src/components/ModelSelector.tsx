        ...
        {isCurrentModelFree && (
          ...
          >
            <TooltipTrigger asChild>
              <button
                type="button"
                className="inline-flex items-center justify-center p-0 rounded-none border-0 bg-transparent hover:bg-transparent focus:bg-transparent active:bg-transparent focus:outline-none focus-visible:outline-none focus:ring-0 focus-visible:ring-0 focus:border-0 active:outline-none"
            ...
            <TooltipContent
              ...
              collisionPadding={8}
            >
              <p>You are using a free model. For better results, switch to a premium model.</p>
            </TooltipContent>
          </Tooltip>
        )}
        <Popover open={open} onOpenChange={setOpen}>
          <PopoverTrigger asChild>
            <Button
              ...
              aria-expanded={open}
              className={cn(
                "h-8 p-0 gap-0.5 justify-between text-xs border-0 bg-transparent hover:bg-transparent hover:text-foreground focus-visible:ring-0 focus-visible:ring-offset-0 text-muted-foreground text-right flex-1 min-w-0"
              )}
              disabled={disabled}
            >
