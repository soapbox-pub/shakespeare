  ...
  return (
    <div className="space-y-3">
      <div className="flex items-center gap-2">
        ...
        <h4 className="text-sm font-medium">{t('plugins')}</h4>
      </div>
      ...
      {plugins.length > 0 ? (
        <div className="space-y-2">
          {plugins.map((pluginName) => {
            ...
            return (
              <Accordion key={pluginName} type="single" collapsible className="w-full">
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="flex gap-2 pt-2">
                        <Button
                          variant="outline"
                          size="sm"
                          onClick={() => handleSyncPlugin(pluginName)}
                        ...
                        <Button
                          variant="destructive"
                          size="sm"
                          onClick={() => handleDeletePlugin(pluginName)}
                          disabled={isSyncing || isDeleting}
                          className="flex-1"
                        >
                          {isDeleting ? (
